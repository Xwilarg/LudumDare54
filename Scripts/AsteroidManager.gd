...
var _default_spawns = []
var asteroid_types = {"RED": {"material": preload("res://Materials/red.tres")}, "GRN": {"material": preload("res://Materials/red.tres")}, "BLU": {"material": preload("res://Materials/red.tres")}}
